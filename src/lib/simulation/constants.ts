...
export const REALTIME_TOUCHDOWN_BONUS_MS = 4_000;

/** Dramatic pause after a turnover */
export const REALTIME_TURNOVER_BONUS_MS = 3_000;

/** Estimated total game duration including all delays (~35 min) */
export const ESTIMATED_GAME_DURATION_MS = 35 * 60 * 1000;
